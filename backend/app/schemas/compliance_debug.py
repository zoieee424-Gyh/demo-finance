"""Debug response schema for compliance endpoint."""
...
class ComplianceDebugResponse(BaseModel):
    mode: Literal["compliance_direct"] = "compliance_direct"
    forced_intent: Intent = "compliance"
