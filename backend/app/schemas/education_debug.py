"""Debug response schema for education endpoint."""
...
class EducationDebugResponse(BaseModel):
    mode: Literal["education_direct"] = "education_direct"
    forced_intent: Intent = "education"
